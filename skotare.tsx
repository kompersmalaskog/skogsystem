...
<div class="page" id="s_page">
  ...
  <div class="g2">
    ...
    <div class="card anim" style="animation-delay:0.35s;cursor:pointer;" onclick="s_openTid()">
      ...
      <div class="card-b">
        <div class="tbar">
          <div class="tseg" style="flex:64;background:rgba(90,255,140,0.25)"></div>
        ...
        <div class="tleg">
          <div class="tli"><div class="tld" style="background:rgba(255,255,255,0.3)"></div>Processar 64%</div>
...
<div class="bolag-panel" id="s_tidPanel">
  ...
  <div class="forar-body">
    ...
    <div style="background:var(--surface2);border-radius:10px;padding:14px 16px;margin-bottom:20px;">
      <div class="frow"><span class="frow-l">Processar</span><div style="flex:1;margin:0 12px"><div class="prog"><div class="pf" style="width:64%;background:rgba(90,255,140,0.4)"></div></div></div><span class="frow-v">96h · 64%</span></div>
      ...
      <div class="frow"><span class="frow-l">Korta stopp</span><div style="flex:1;margin:0 12px"><div class="prog"><div class="pf" style="width:2%;background:rgba(91,143,255,0.3)"></div></div></div><span class="frow-v">3h · 2%</span></div>
