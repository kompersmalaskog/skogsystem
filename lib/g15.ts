...
// G15-tid = processing + terrain + other_work. Validerat mot FYRA tillverkar-
// rapporter / 2 fabrikat: Ponsse "Effektiv tid" (Scorpion/Elefant/Wisent) och
// Rottne "Grundtid G(t)" (H8E) är samma sak och inkluderar BÅDA övrigt arbete.
// P+T ensam underskattar 3–6 % → m³/G15h och kr/G15h överskattas. ENDA
