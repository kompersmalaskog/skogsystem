...
// ── Prislistetillägg: kvalitetssäkring/ForestLink + terräng ──
//
// Kvalitetssäkring (acord_ovrigt nyckel 'kvalitetssakring'): fast kr/m³fub
// som ALLTID ingår i ackordet, på alla objekt. Läses ur prislistan —
