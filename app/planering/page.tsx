...
export default function PlannerPage() {
  ...
  const handleMapReady = useCallback((map: any) => {
    ...
    const wmsLayerDefs = [
      ...
      { id: 'sks_markfuktighet', tiles: ['/api/wms-proxy?layer=sks_markfuktighet&bbox={bbox-epsg-4326}&width=256&height=256'] },
      { id: 'sks_virkesvolym', tiles: ['/api/wms-proxy?layer=sks_virkesvolym&bbox={bbox-epsg-4326}&width=256&height=256'] },
      { id: 'sks_tradhojd', tiles: ['/api/wms-proxy?layer=sks_tradhojd&bbox={bbox-epsg-4326}&width=256&height=256'] },
      { id: 'sks_lutning', tiles: ['/api/wms-proxy?layer=sks_lutning&bbox={bbox-epsg-4326}&width=256&height=256'] },
    ];
